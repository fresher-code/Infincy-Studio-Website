...
const cases = [
  {
    ...
    problem: 'Turning natural-language prompts into fully functional application workflows was slow and required manual full-stack development for every screen.',
    approach: 'Built a multi-agent architecture (LangGraph) that generates synchronized frontend screens and backend APIs from a single prompt, with reusable screens and tool integrations.',
    outcome: 'A working workflow builder that lets users assemble complete application pipelines by connecting AI-generated screens and tools.',
  },
  {
    number: '02',
    title: 'Regulatory RAG pipeline',
    subtitle: 'Compliance reporting',
    problem: 'Analyzing banking regulations and producing compliance reports manually was slow and inconsistent.',
    approach: 'Designed and deployed a production RAG pipeline using vector search (Pinecone), embeddings, and LLMs to retrieve relevant regulatory context automatically.',
    outcome: 'Compliance reports generated in under 60 seconds, with consistent, retrievable source context.',
  },
  {
    number: '03',
      ...
      <div className="page-wrap">
        <div className="footer-grid">
          ...
          <div>
            ...
            <a className="footer-link" href="https://github.com" target="_blank" rel="noreferrer" data-testid="link-footer-github">
              <Github size={13} /> GitHub
            </a>
            <a className="footer-link" href="https://linkedin.com" target="_blank" rel="noreferrer" data-testid="link-footer-linkedin">
              <Linkedin size={13} /> LinkedIn
            </a>
            <a className="footer-link" href="mailto:hello@infincy.dev" data-testid="link-footer-email">
              <Mail size={13} /> hello@infincy.dev
            </a>
          </div>
        </div>
          ...
          <div className="work-grid">
            {cases.map((item, index) => (
              <article className="work-card" key={item.title} data-testid={`card-home-work-${index}`}>
                <Placeholder className="work-placeholder">[project screenshot]</Placeholder>
    ...
    <>
      ...
      <section className="section">
        ...
        <div className="page-wrap founder-photo-wrap">
          <Placeholder className="founder-placeholder">[founder photo]</Placeholder>
          <p className="photo-caption">A real photo belongs here. For now, this frame is a promise to keep the work personal.</p>
        </div>
      </section>
        ...
        <div className="page-wrap">
          {cases.map((item, index) => (
            <article className="case-study" key={item.title} data-testid={`case-study-${index}`}>
              <div className="case-visual"><Placeholder className="project-placeholder">[project screenshot]</Placeholder></div>
              <div>
        ...
        <div className="page-wrap contact-grid">
          ...
          <div>
            ...
            <div className="contact-details">
              <div><h3>Prefer a direct note?</h3><a href="mailto:hello@infincy.dev" data-testid="link-contact-email">hello@infincy.dev</a></div>
